...
MULTIFX_API_RET (*var_param_func)(MULTIFX_FLOATING_T,MULTIFX_FLOATING_T,MULTIFX_UINT32_T,MULTIFX_FLOATING_T*,MULTIFX_FLOATING_T,MULTIFX_FLOATING_T,MULTIFX_FLOATING_T*);//(MULTIFX_FLOATING_T f_samp, MULTIFX_FLOATING_T f_synth, MULTIFX_UINT32_T len_frame, MULTIFX_FLOATING_T *out_frame, MULTIFX_FLOATING_T phase_offset, MULTIFX_FLOATING_T amp,MULTIFX_FLOATING_T* old_phase)
};
...
MULTIFX_API_RET OSC_trigger(OSCILLATOR_T *p_osc,MULTIFX_FLOATING_T* tv_parameters,MULTIFX_UINT32_T param_idx,MULTIFX_UINT32_T len_frame)
{
    ...
    ret = (p_osc->var_param_func)(p_osc->sample_rate,p_osc->freq,len_frame,p_osc->tv_parameter,p_osc->phase_offset, p_osc->amp,p_osc->oscillator_state);
